...
def _check_against_expected(config_dict, expected):
    ...
    with io.BytesIO() as fd_actual:
        ...
        with open(expected, 'rb') as fd_expected:
            n = 0
            for expected_line in fd_expected:
                actual_line = fd_actual.readline()
                n += 1
                assert actual_line.strip() == expected_line.strip(), \
                    "[%d] '%s' vs '%s'" % (n, actual_line, expected_line)
...
class TestUpgrade:
    ...
    def test_upgrade_v25(self):
        ...
        _check_against_expected(config_dict, 'expected/weewx25_expected.conf')
    ...
    def test_upgrade_v26(self):
        ...
        _check_against_expected(config_dict, 'expected/weewx26_expected.conf')
    ...
    def test_upgrade_v30(self):
        ...
        _check_against_expected(config_dict, 'expected/weewx30_expected.conf')
    ...
    def test_upgrade_v32(self):
        ...
        _check_against_expected(config_dict, 'expected/weewx32_expected.conf')
    ...
    def test_upgrade_v36(self):
        ...
        _check_against_expected(config_dict, 'expected/weewx36_expected.conf')
    ...
    def test_upgrade_v39(self):
        ...
        _check_against_expected(config_dict, 'expected/weewx39_expected.conf')
    ...
    def test_upgrade_v40(self):
        ...
        _check_against_expected(config_dict, 'expected/weewx40_expected.conf')
    ...
    def test_upgrade_v42(self):
        ...
        _check_against_expected(config_dict, 'expected/weewx42_expected.conf')

    def test_upgrade_v43(self):
        """Test an upgrade of the stock v4.2 weewx.conf to V4.3"""
    ...
    def test_merge(self):
        ...
        # Check the results.
        _check_against_expected(check_dict, 'expected/weewx43_user_expected.conf')
